...
TOP_K = 20
"""Survey ranking cut. The manuscript positively identifies nine textbook
field-defining renaissances among these top-20 step-change communities
(spanning eleven rank slots, with #2 + #20 forming a CMR-manganite sister
pair and #11 + #14 a double-perovskite companion pair). The remaining
nine ranks are program-driven systematic surveys, applied-chemistry
surges, or one community without a single anchoring event — not missed
renaissances. The top-20 cut keeps the ranking table tractable for the
