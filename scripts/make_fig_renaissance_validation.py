...
def main() -> int:
    ...
    survey_json = require_zenodo_file(
        args.survey_json,
        what="top-community renaissance survey driving Fig 2",
    )
    ...
    ax_c.set_title("(c) Top-16 communities by birth-year step-change — 9 textbook field-defining renaissances positively identified (teal). "
