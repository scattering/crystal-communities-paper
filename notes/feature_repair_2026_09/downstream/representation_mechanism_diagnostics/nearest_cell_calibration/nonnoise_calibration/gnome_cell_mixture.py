...
def main():
    ...
    output = {
        "diagnostic": "Later-ICSD acceptance standardized to GNoME nearest-cell mixture after original-nonnoise cell-consistent historical radius calibration",
        "definition": "On cells occupied by both later ICSD and GNoME, adjusted ICSD acceptance is sum_c [n_GNoME,c / sum_c n_GNoME,c] * [in_ICSD,c / n_ICSD,c]. Compare with GNoME acceptance on those exact supported cells. The existing original-nonnoise-calibration in_basin flags are unchanged.",
    ...
    lines = ["# GNoME cell-mixture standardization after nonnoise nearest-cell calibration", "", output["definition"], "",
